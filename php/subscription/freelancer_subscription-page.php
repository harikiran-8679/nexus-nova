...
if (!isset($_SESSION['fname'])) {
    header('Location: ../register/freelancer-register.php'); // Redirect to signup if session is not set
    exit();
}
?>
        ...
        <div class="menu">
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div>
                        <a id="Subcon" href="../about/howtohire.php">How to hire a freelancer</a> 
                    </div>
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div>
                        <a id="Subcon" href="../about.howtohire.php">How to find work and earn money</a> 
                    </div>


                    <div>
                        <a id="Subcon" href="../search/clientz.php">Find Work</a> <br>
                    </div>
